...
export default function StepPaymentMethod({ onUploadChange }) {
  ...
  const handleFileUpload = (event) => {
    ...
    if (file && onUploadChange) {
      onUploadChange(file); // <-- envía el archivo real, no solo un booleano
    }
  };
    ...
    <Container maxWidth="lg">
      <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
        ...
        <FormControl component="fieldset" fullWidth>
          ...
          <RadioGroup name="payment-method" value={paymentMethod} onChange={handlePaymentChange}>
            <FormControlLabel
              value="transfer"
              control={<Radio />}
